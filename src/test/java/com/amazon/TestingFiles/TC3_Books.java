...
public class TC3_Books {
	...
	// "/Users/tatianakesler/Desktop/Selenium/installation/geckodriver");
	// wd = new FirefoxDriver();
	// }
	...
	public void BooksSectionTest() throws InterruptedException {
		...
		search.selectBooksAudible();
		search.ChildrenBooks();
	...
	public void afterMethod(ITestResult testResult) throws IOException {
		if (testResult.getStatus() == ITestResult.FAILURE) {
			String path = utilities.FailedTCScreenshot.ScreenShotMethod.TakeScreenshot(wd, testResult.getName());
